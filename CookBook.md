...
The data being analysis names "Human Activity Recognition Using Smartphones Dataset (Version 1.0)", obtained from [Smartlab - Non Linear Complex Systems Laboratory](http://www.smartlab.ws) DITEN - Universit‡ degli Studi di Genova. Via Opera Pia 11A, I-16145, Genoa, Italy.
